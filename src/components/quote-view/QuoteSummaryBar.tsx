  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden">
      <div className="flex items-stretch">
        ...
        <div className="flex-1 px-5 py-3 bg-gray-900 text-white">
          <div className="text-[10px] text-gray-400 mb-0.5">최종 고객가</div>
          <div className="text-lg font-bold">{fmt(total)}원</div>
          <div className="text-[10px] text-gray-400">1인당 {fmt(perPerson)}원</div>
        </div>
      </div>
    </div>
  )
